...
ifInDiscards = [  1, 3, 6, 1, 2, 1, 2, 2, 1, 13 ] ::RawOID
ifOutDiscards = [1, 3, 6, 1, 2, 1, 2, 2, 1, 19] ::RawOID
ifInErrors = [1, 3, 6, 1, 2, 1, 2, 2, 1, 14]  ::RawOID
ifOutErrors =   [1, 3, 6, 1, 2, 1, 2, 2, 1, 20] ::RawOID
